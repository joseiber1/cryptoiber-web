...
import { CalendarCheck, Cpu, Wrench, Zap, ShieldCheck, MapPin, Phone, Mail } from "lucide-react";
...
export default function Home() {
  ...
  function enviarWhatsApp() {
    const mensaje = `Hola, quiero agendar una revisión técnica.%0A%0A` +
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <h1 className="text-2xl font-black tracking-tight text-sky-700">CRYPTOIBER</h1>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-6 md:grid-cols-3">
          <div>
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">
              Servicio técnico especializado en máquinas de minería.
            </p>
          </div>
          <div>
